...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Handle initial page routing based on current URL
    ...
    // Initialize the app and handle routing after DB is ready
    initializeApp().then(() => {
        // Handle initial routing after app initialization
        handleInitialRoute();
    }).catch(error => {
        console.error('App initialization failed:', error);
        // Still try to handle routing even if initialization fails
        handleInitialRoute();
    });
