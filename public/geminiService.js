// geminiService.js - Modified for Express.js backend
...
/**
 * Express 서버로 요청을 보내고 스트리밍 응답을 처리하는 비동기 제너레이터 함수입니다.
 * @param {object} body - Express 서버로 보낼 요청 본문 (JSON)
...
async function* streamResponseFromServer(body) {
    try {
        ...
        console.error("Express 서버 fetch 오류:", error);
...
/**
 * 이미지를 분석하고 설명을 생성하기 위해 Express 서버를 호출합니다.
...
/**
 * 텍스트 프롬프트를 처리하고 답변을 생성하기 위해 Express 서버를 호출합니다.
