// v2.3 최신 스트리밍 버전: Google Gemini API 프록시 (Netlify Functions)


// Netlify 스트리밍 응답을 위한 헬퍼 함수
...
exports.handler = async (event) => {
  // Netlify 런타임 중복 선언 오류 방지: require를 함수 내부로 이동
  ...
  try {
    ...
    return {
      ...
      body: streamResponse(responseStream),
    };
